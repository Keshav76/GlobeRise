...
const Dashboard = () => {
  ...
  const StatCard = ({ title, value, icon: Icon, color, onClick, small = false }) => {
    const colorClasses = {
      purple: { border: 'border-2 border-purple-500', text: 'text-purple-600', iconBg: 'bg-purple-100' },
      green: { border: 'border-2 border-green-500', text: 'text-green-600', iconBg: 'bg-green-100' },
      red: { border: 'border-2 border-red-500', text: 'text-red-600', iconBg: 'bg-red-100' },
      orange: { border: 'border-2 border-orange-500', text: 'text-orange-600', iconBg: 'bg-orange-100' },
      blue: { border: 'border-2 border-blue-500', text: 'text-blue-600', iconBg: 'bg-blue-100' },
    };
    ...
    return (
      <div
        className={`bg-white rounded-lg shadow-md ${colorStyle.border} ${small ? 'p-4' : 'p-6'} cursor-pointer hover:shadow-lg transition-all`}
        onClick={onClick}
      >
        <div className="flex items-center justify-between">
          <div className="flex-1">
            <p className="text-sm font-medium text-gray-600 mb-1">{title}</p>
            <p className={`${small ? 'text-xl' : 'text-2xl'} font-bold text-gray-800`}>{value}</p>
          </div>
          <div className={`${colorStyle.iconBg} ${small ? 'p-2' : 'p-3'} rounded-full`}>
            <Icon className={`${small ? 'text-xl' : 'text-2xl'} ${colorStyle.text}`} />
          </div>
          {onClick && <FaArrowRight className="text-gray-400 ml-2" />}
        </div>
      </div>
    );
  };
  ...
  const DepositWithdrawCard = ({ title, value, icon: Icon, color, onClick, border }) => {
    ...
    return (
      <div
        className={`p-4 cursor-pointer hover:bg-gray-100 border-gray-200 transition-all ${border}`}
        onClick={onClick}
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4 flex-1">
            ...
            <div className="flex-1">
              <p className="text-xl text-gray-800 mb-1">{value}</p>
              <p className="text-sm font-medium text-gray-600">{title}</p>
            </div>
          </div>
          {onClick && <FaArrowRight className="text-gray-400 text-lg" />}
        </div>
      </div>
    );
  };
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-2">
            {dateRange && (
              <div className="text-sm text-gray-600 border border-gray-300 rounded px-3 py-1 flex items-center cursor-pointer hover:bg-gray-50">
                {dateRange}
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className='bg-white rounded-lg mr-2'>
          <h2 className="text-xl font-semibold text-gray-800 m-5 mb-0">Deposits</h2>
        ...
        <div className='bg-white rounded-lg ml-2'>
          <h2 className="text-xl font-semibold text-gray-800 m-5 mb-0">Withdrawals</h2>
          <div className="grid grid-cols-2 p-4">
            <DepositWithdrawCard
              border='border-r-1 border-b-1'
